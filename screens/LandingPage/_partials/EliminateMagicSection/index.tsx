...
import eliminateMagicImg from "@/assets/images/eliminate-magic-image.png";
        ...
        <div className="flex flex-col lg:flex-row gap-0 lg:gap-16">
          ...
          >
            ...
            >
              ...
              cash
              <br className="hidden lg:block" /> Disappearances
            </motion.h2>
            <motion.p
            ...
            >
              Track every transaction, whether cash, transfer, or card. Monitor
              staff performance and ensure every Naira lands in your business
              account.
            </motion.p>
          </motion.div>

          {/* Right: image section — same structure as SecureYourTimeSection */}
          <motion.div
          ...
          >
            ...
            >
              <Image
                src={eliminateMagicImg}
                alt="Professional tracking transactions with tablet"
                fill
...
export default EliminateMagicSection;
